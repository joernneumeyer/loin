...
const projectDirectory  = '/home/anon/Code/github-repos/loin';// process.argv[1];
  ...
  if (cmd & CMD_INSTALL) {
    if (process.argv[3]) {
      const packagePath =
              ...
              ? process.argv[3]
              : path.join(projectConfigPath, process.argv[3]);
      console.log('Starting installation...');
      const pack = await installPackage(projectConfigPath, packagePath);
      console.log(`Successfully installed package '${pack.name}'.`);
    }
  }
})();
